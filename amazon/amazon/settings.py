...
SECRET_KEY = "django-insecure-04lwu)ckg6_axco$fbm*k21*-hz2uc3g8+$losev_*ta$dj08x"
...
DATABASES = {
    'default': {
        ...
        'USER': 'amazon_user', # Usuário do PostgreSQL amazon_user
        'PASSWORD': 'amazon123', # Senha do usuário amazon123
        'HOST': 'localhost', # Nome do servidor PostgreSQL
